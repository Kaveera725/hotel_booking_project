...
const ListRoom = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Room Listings' subtitle='View, edit, or mange all listed rooms. 
                        ...
                        rooms.map((item, index) => (
                          <tr key={index} >
                            ...
                            <td className='py-3 px-4 border-t border-gray-300 text-sm text-red-500 text-center'>
                              <label htmlFor='' className='relative inline-flex item-center cursor-pointer text-gray-900 gap-3'>
