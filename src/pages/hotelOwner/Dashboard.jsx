                ...
                <table className='w-full'>
                    ...
                    <tbody className='text-sm'>
                        {dashboardData.bookings.map((item, index) => (
                            <tr key={index} className='py-3 px-4 text-gray-700 border-t border-gray-300'>
                                ...
                                <td className='py-3 px-4 text-gray-700 border-t border-gray-300 flex'>
                                    <button className={`py-1 px-3 text-sx rounded-full mx-auto ${item.isPaid ? 'bg-green-200 text-green-600' : 'bg-amber-200 text-yellow-600'}`}>
